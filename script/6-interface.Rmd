...
<!--Up to here at rstudio conf.  I think this took an hour
based on commit history.  I had used the first 30 min of this
session to finish using tidyverse in packages. -->
